...
import { assertHttpUrl, fetchFeedXml } from './network.js';
import { resolveOpmlOutputPath } from './workspace.js';
export { isBlockedNetworkAddress } from './network.js';
 ...
 */
export function buildRssTools(config, settingsScope, fetchImpl, lookupImpl) {
    const cfg = config;
    const getFeeds = () => {
